...
public class EditorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Find all the relevant values that we need to read the user input from
    ...
    /**
     * Setup the dropdown spinner that allwos the user to select gender of a pet
     */
        ...
        public boolean onOptionsItemSelected (MenuItem item){
            ...
            switch (item.getItemId()) {
                ...
                case R.id.action_save:
                    //Enter the new pet information from Editor activity to the database
                    insertPet();
                    //Return the user back to catalog activity
                    finish();
                    return true;
